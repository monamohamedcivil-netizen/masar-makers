...
export default async function PageBuilderPage({
  ...
  const panels =
    await getPanelsByTemplateId(templateId);

  const createPanelAction =
    createTemplatePanel.bind(
      null,
      templateId
    );
        ...
        >
          ...
          >
            <input
              ...
              type="text"
              required
              placeholder="اسم الـ Panel الجديد"
              className="
                min-h-12 flex-1
                rounded-xl
                border border-[#DCE3EB]
          ...
          {panels.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link
                     href={`/admin/page-builder/${templateId}/panels/${panel.id}`}
                      className="
                        inline-flex h-10
                        items-center justify-center
                        gap-2 rounded-xl
            ...
            >
              ...
              <h2 className="mt-4 text-lg font-black text-[#07152E]">
                لا توجد Panels حتى الآن
              </h2>

              <p className="mt-2 text-xs font-bold text-slate-500">
                اكتبي اسم أول Panel ثم اضغطي إضافة.
              </p>
            </div>
          )}
        </section>
