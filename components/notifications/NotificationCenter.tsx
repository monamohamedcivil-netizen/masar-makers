...
export default function NotificationCenter() {
  ...
  const openNotification = async (
    ...
    if (notification.actionUrl) {
      /*
       * Do not refresh immediately after navigation.
       * Refreshing the current route can finish before
       * router.push(), so the notification disappears
