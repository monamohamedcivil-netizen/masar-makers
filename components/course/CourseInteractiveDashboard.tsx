    ...
    startTransition(async () => {
      const result =
        await swapPanelOrder({
          ...
          secondId:
            targetItem.databaseId,

          secondOrder:
            targetItem.displayOrder,
        });
          ...
          >
            <SideMenu
              ...
              onEditTitle={() =>
                selectElement({
                  id:
                    `learning-column-title-${stationId}`,

                  type: "title",

                  label:
                    "عنوان عمود طريقة التعلم",
          ...
          >
            <SideMenu
              ...
              onEditTitle={() =>
                selectElement({
                  id:
                    `result-column-title-${stationId}`,

                  type: "title",

                  label:
                    "عنوان عمود نتائج الرحلة",
